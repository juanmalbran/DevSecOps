...
| [`lint-snyk.yaml`](lint-snyk.yaml) | Job "Security Snyk Checks": escanea dependencias y sube el **SARIF** (el formato estándar en el que las herramientas reportan hallazgos de seguridad) a GitHub Code Scanning |
